  ...
  <div class="view">
    ...
    <div class="gz bg-box">
      ...
      <div class="contet">
        ...
        <div>
          <p>3.转账的哈希值最后一位数字（忽略字母）作为开奖结果。</p>
          <p>大：<span style="color:red;">5、6、7、8、9</span>。</p>
          <p>小：<span style="color:red;">0、1、2、3、4</span>。</p>
          <p>单：<span style="color:red;">1、4、5、7、9</span>。</p>
          <p>双：<span style="color:red;">0、2、4、6、8</span>。</p>
          <p>4.转账的<span style="color:red;"> 个位数</span>来判定下注类型。</p>
          <p>交易的最后一位数字<span style="color:red;">1：小</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">2：大</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">3：单</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">4：双</span>。</p>
          <p>5.冷钱包TRC20-USDT转账随机产生的区块哈希值。</p>
          <p>6.<span style="color:red;">从右到左的第一个数字</span>作为幸运PC的抽奖结果。</p>
        </div>
