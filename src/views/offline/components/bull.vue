  ...
  <div class="view">
    <div class="addressBox bg-box">
      ...
      <div class="address flex-center-center">
        TUho3affT5szRWVovreJafGicqz4266666
      </div>

      <div>
        <van-button class="btn-copy" size="large" round type="primary">一键复制</van-button>
      </div>
    </div>
    ...
    <div class="gz bg-box">
      ...
      <div class="contet">
        ...
        <div>
          <p>3.
            取区块链Block Hash值后五位作为开奖结果，后五位中的前三位之和的个位作为庄的点数，后五位中的后三位之和的个位作为闲的点数；字母=10点。</p>
          <p>4.庄点数大于闲点数则“庄”胜；闲点数大于庄点数则“闲”胜；玩家押注庄或闲的时候，开奖结果是和，扣除千分之一的手续费退还本金，玩家可押注庄闲平倍与翻倍玩法</p>
          <p>5.押注<span style="color:red;">翻倍玩法</span>需要转账三倍押注金额,例如：押注<span style="color:red;">100U</span>庄(翻倍)，则需要转帐<span style="color:red;">302U</span>到押注地址。</p>
          <p> 以牛1~牛5赢牌：赔 <span style="color:red;">下注金额+1倍*下注金额*0.95</span> </p>
          <p> 以牛6~牛9赢牌：赔 <span style="color:red;">下注金额+2倍*下注金额*0.95</span> </p>
          <p> 以牛牛赢牌：赔 <span style="color:red;">下注金额+3倍*下注金额*0.95</span> </p>
          <p>6.转账的<span style="color:red;"> 个位数</span>来判定下注类型。</p>
          <p>交易的最后一位数字<span style="color:red;">1：庄(平倍)</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">2：庄(翻倍)</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">5：闲(平倍)</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">6：闲(翻倍)</span>。</p>
          <p>交易的最后一位数字<span style="color:red;">4：和局</span>。</p>
          <p>转账金额个位数，不在投注游戏玩法类型范围内，属于无效投注退本金。</p>
        </div>

        <div>
          4.中奖赔率:<span style="color: red;"><span>庄:0.95，</span><span>闲:0.95，</span><span>和局:9.5</span></span>
        </div>
      </div>
    </div>
  </div>
