    ...
    <div class="gz bg-box">
      ...
      <div class="contet">
        ...
        <div>
          ...
          <p>4.转账的<span style="color:red;"> 个位数</span>来判定下注号码。转账金额的个位数与开奖结果一致。中奖</p>
          <p>示例：投注<span style="color:red;">101</span>USDT，投注金额个位数为<span style="color:red;">"1"</span>,
            系统将判断为您的下注号码为<span style="color:red;">"1"</span>，转账的哈希值最后一位数字（忽略字母）为<span style="color:red;">"1"</span> 时，即为中奖！</p>
        </div>

        <div>
          4.中奖赔率:<span style="color: red;">9.8</span>
        </div>
      </div>
    </div>
